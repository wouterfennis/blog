...
With Terraform and Pulumi the maintenance of the tools is done by third party companies, so the feedback loop when new resources can be released to the cloud can be a bit longer. They do, however, support Azure, AWS and other cloud providers. So they can be an excellent fit in an enterprise broad infrastructure as code strategy.
